...
const INCREMENT_ONBOARDING_STEP = "INCREMENT_ONBOARDING_STEP";
...
function reducer(state = initialState, action) {
  switch (action.type) {
    ...
    case INCREMENT_ONBOARDING_STEP:
        return {...state, currentOnboardingStep: state.currentOnboardingStep + 1};    
      default:
    return state;
  }
}
